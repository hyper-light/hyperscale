...
setup(
    ...
    url="https://github.com/hyper-light/hyperscale",
    ...
    entry_points={
        "console_scripts": [
            "hyperscale=hyperscale.cli:run",
            "hyperscale-server=hyperscale.run_uwsgi:run_uwsgi",
        ],
    },
    extras_require={
        "all": [
        ...
        "datadog": ["datadog-api-client", "aiosonic"],
        "mongodb": ["motor"],
