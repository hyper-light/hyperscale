...
class BaseParser:
    def __init__(
        ...
        self.timeouts = Timeouts(
            connect_timeout=config.connect_timeout, total_timeout=config.request_timeout
        )
    ...
    ) -> Coroutine[Any, Any, ActionHook]:
        raise NotImplementedError(
            "Parse method is not implemented for base Parser class."
        )
