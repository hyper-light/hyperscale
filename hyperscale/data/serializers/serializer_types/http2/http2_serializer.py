...
class HTTP2Serializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> HTTP2Action:
    ...
    def result_to_serializable(self, result: HTTP2Result) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> HTTP2Result:
