...
from hyperscale.core.engines.types.http.client import MercuryHTTPClient
...
class HTTPSerializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> HTTPAction:
    ...
    def result_to_serializable(self, result: HTTPResult) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> HTTPResult:
