...
from hyperscale.core.engines.types.graphql.client import MercuryGraphQLClient
...
class GraphQLSerializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> GraphQLAction:
    ...
    def result_to_serializable(self, result: GraphQLResult) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> GraphQLResult:
