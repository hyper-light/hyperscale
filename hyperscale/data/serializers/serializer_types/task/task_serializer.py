...
class TaskSerializer(BaseSerializer):
    ...
    def action_to_serializable(self, task: Task) -> Dict[str, Union[str, List[str]]]:
    ...
    def deserialize_task(self, task: Dict[str, Any]) -> Task:
    ...
    def result_to_serializable(self, result: TaskResult) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> TaskResult:
        task_action = Task(
            result.get("name"),
            None,
        ...
        task_result = TaskResult(task_action, error=result.get("error"))
