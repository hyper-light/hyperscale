...
from hyperscale.core.engines.types.graphql_http2.client import MercuryGraphQLHTTP2Client
...
class GraphQLHTTP2Serializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> GraphQLHTTP2Action:
    ...
    def result_to_serializable(self, result: GraphQLHTTP2Result) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> GraphQLHTTP2Result:
