...
from hyperscale.core.engines.types.http3.client import MercuryHTTP3Client
...
class HTTP3Serializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> HTTP3Action:
    ...
    def result_to_serializable(self, result: HTTP3Result) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> HTTP3Result:
