...
from hyperscale.core.engines.types.grpc.client import MercuryGRPCClient
...
class GRPCSerializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> GRPCAction:
    ...
    def result_to_serializable(self, result: GRPCResult) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> GRPCResult:
