...
from hyperscale.core.engines.types.udp.client import MercuryUDPClient
...
class UDPSerializer(BaseSerializer):
    ...
    def deserialize_action(self, action: Dict[str, Any]) -> UDPAction:
    ...
    def result_to_serializable(self, result: UDPResult) -> Dict[str, Any]:
    ...
    def deserialize_result(self, result: Dict[str, Any]) -> UDPResult:
