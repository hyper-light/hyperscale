...
class CassandraHTTP3ActionSchema:
    def __init__(self, table_name: str) -> None:
        ...
        self.actions_table = type(f"{table_name}_http3", (Model,), self.action_columns)
    ...
    def to_schema_record(self, action: HTTP3Action) -> Dict[str, Any]:
