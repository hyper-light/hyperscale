...
from hyperscale.core.engines.types.grpc.protobuf_registry import protobuf_registry
...
class CassandraGRPCActionSchema:
    def __init__(self, table_name: str) -> None:
        ...
        self.actions_table = type(f"{table_name}_grpc", (Model,), self.action_columns)
    ...
    def to_schema_record(self, action: GRPCAction) -> Dict[str, Any]:
        encoded_protobuf = str(
            binascii.b2a_hex(action.data.SerializeToString()),
    ...
    def from_schema_record(self, action: Dict[str, Any]) -> Dict[str, Any]:
        ...
        wire_msg = binascii.b2a_hex(action.get("protobuf"))
