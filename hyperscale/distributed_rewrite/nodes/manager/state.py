...
from hyperscale.distributed_rewrite.protocol.version import NegotiatedCapabilities

if TYPE_CHECKING:
    from hyperscale.core.state.context import Context
    from hyperscale.distributed_rewrite.jobs.timeout_strategy import TimeoutStrategy
    from hyperscale.distributed_rewrite.workflow import WorkflowStateMachine
