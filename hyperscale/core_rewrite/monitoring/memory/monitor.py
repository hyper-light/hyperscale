...
from hyperscale.core_rewrite.monitoring.base.monitor import BaseMonitor
...
class MemoryMonitor(BaseMonitor):
    ...
    def update_monitor(self, run_id: int):
        try:
            ...
            self.active[run_id].append((time.monotonic(), mem_info.rss / 1024**2))
