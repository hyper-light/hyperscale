...
from hyperscale.core_rewrite.engines.client.http2.streams import Stream
from hyperscale.core_rewrite.engines.client.shared.protocols import _DEFAULT_LIMIT
