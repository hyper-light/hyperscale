...
def optimize_stage(serialized_config: str):
    ...
    try:
        ...
        logger.filesystem.sync['hyperscale.optimize'].info(f'{metadata_string} - Setting up Optimization')
        ...
        logger.filesystem.sync['hyperscale.optimize'].info(f'{optimizer.metadata_string} - Optimization complete')
