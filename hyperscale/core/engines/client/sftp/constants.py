...
# Units
NSECS_IN_SEC = 1_000_000_000

# Limits
MAX_SFTP_REQUESTS = 128
MAX_READDIR_NAMES = 128
MAX_SPARSE_RANGES = 128
...
# SSH service names
USERAUTH_SERVICE = b'ssh-userauth'
CONNECTION_SERVICE = b'ssh-connection'

# Max banner and version line length and count
MAX_BANNER_LINES = 1024
MAX_BANNER_LINE_LEN = 8192
MAX_VERSION_LINE_LEN = 255

# Max allowed username length
MAX_USERNAME_LEN = 1024

# Default rekey parameters
DEFAULT_REKEY_BYTES = 1 << 30      # 1 GiB
DEFAULT_REKEY_SECONDS = 3600       # 1 hour

# Default login timeout
DEFAULT_LOGIN_TIMEOUT = 120        # 2 minutes

# Default keepalive interval and count max
DEFAULT_KEEPALIVE_INTERVAL = 0     # disabled by default
DEFAULT_KEEPALIVE_COUNT_MAX = 3

# Default channel parameters
DEFAULT_WINDOW = 2*1024*1024       # 2 MiB
DEFAULT_MAX_PKTSIZE = 32768        # 32 kiB

# Default line editor parameters
DEFAULT_LINE_HISTORY = 1000        # 1000 lines
DEFAULT_MAX_LINE_LENGTH = 1024     # 1024 characters
