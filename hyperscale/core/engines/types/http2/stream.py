...
from hyperscale.core.engines.types.common.encoder import Encoder
from hyperscale.core.engines.types.common.protocols.shared.reader import Reader
...
from hyperscale.core.engines.types.http2.windows.window_manager import WindowManager
...
class Stream:
    ...
    def __init__(self, stream_id: int, timeouts: Timeouts) -> None:
        ...
        self._remote_settings_dict = {
            ...
            for setting_name, setting_value in self._remote_settings.items()
        }
