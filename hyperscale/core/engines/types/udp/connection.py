...
from hyperscale.core.engines.types.common.protocols import UDPConnection as UDP
from hyperscale.core.engines.types.common.protocols.shared.constants import (
    _DEFAULT_LIMIT,
)
