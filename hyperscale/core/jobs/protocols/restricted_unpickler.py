...
def is_module_allowed(module: str) -> bool:
    """
    Check if a module would be allowed by the restricted unpickler.
...
def get_blocked_modules() -> FrozenSet[str]:
    """Return the set of blocked modules."""
    return BLOCKED_MODULES


def get_blocked_classes() -> FrozenSet[Tuple[str, str]]:
    """Return the set of blocked module.class combinations."""
