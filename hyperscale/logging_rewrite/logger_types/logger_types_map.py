...
class LoggerTypesMap:
    def __init__(self) -> None:
        ...
        self.async_loggers: Dict[
            LoggerTypes, Union[AsyncLogger, AsyncFilesystemLogger]
        ] = {
            LoggerTypes.CONSOLE: AsyncLogger,
            LoggerTypes.DISTRIBUTED: AsyncLogger,
            LoggerTypes.HYPERSCALE: AsyncLogger,
        ...
        self.sync_loggers: Dict[
            LoggerTypes, Union[SyncLogger, SyncFilesystemLogger]
        ] = {
            LoggerTypes.CONSOLE: SyncLogger,
            LoggerTypes.DISTRIBUTED: SyncLogger,
            LoggerTypes.HYPERSCALE: SyncLogger,
        ...
        self.logger_names = {
            ...
            for logger_name, logger_type in self.logger_types.items()
        }
