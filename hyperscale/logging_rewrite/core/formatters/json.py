...
from hyperscale.logging_rewrite.core.levels import LEVEL_TO_NAME
from hyperscale.logging_rewrite.core.records import LogRecord, ExtendedLogRecord
from hyperscale.logging_rewrite.core.utils import CallableWrapper
