...
from hyperscale.logging_rewrite.core import Logger
from hyperscale.logging_rewrite.core.utils import create_task
from hyperscale.logging_rewrite.core.formatters.base import Formatter
from hyperscale.logging_rewrite.core.formatters.json import ExtendedJsonFormatter
from hyperscale.logging_rewrite.core.levels import LogLevel
from hyperscale.logging_rewrite.core.logger import _Caller
from hyperscale.logging_rewrite.core.records import ExtendedLogRecord
...
class JsonLogger(Logger):
    ...
    def with_default_handlers(  # type: ignore
        ...
        *,
        ...
        serializer: Callable[..., str] = orjson.dumps,
        flatten: bool = False,
        serializer_kwargs: Dict = None,
        extra: Dict = None,
