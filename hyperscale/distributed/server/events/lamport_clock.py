...
class VersionedStateClock:
    ...
    def is_entity_stale(
        ...
        """
        current = self.get_entity_version(entity_id)
        if current is None:
            return False  # Unknown entity, accept update
    ...
    def should_accept_update(
        ...
        """
        return not self.is_entity_stale(entity_id, incoming_version)
    ...
    def cleanup_old_entities(self, max_age_seconds: float = 300.0) -> list[str]:
        """
