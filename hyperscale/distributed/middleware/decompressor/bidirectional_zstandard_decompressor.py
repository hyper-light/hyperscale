    ...
    async def __pre__(
        ...
        try:
            ...
            if request.raw != b"" and content_encoding == "gzip":
                request.content = self._decompressor.decompress(request.content)
            ...
            return (
                request,
                Response(request.path, request.method, headers=request_headers),
                200,
            ), True
        ...
        try:
            if response is None:
                ...
                if content_encoding == "gzip":
                    ...
                    decompressed_data = self._decompressor.decompress(serialized)
