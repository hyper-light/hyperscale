...
from pydantic import BaseModel, IPvAnyAddress, StrictFloat, StrictInt, StrictStr

from hyperscale.distributed.discovery.dns.core.exceptions import InvalidServiceURLError
