...
class GraphQLHTTP2ProcessedResult(HTTP2ProcessedResult):
    ...
    def __init__(self, stage: str, result: GraphQLHTTP2Result) -> None:
        super(GraphQLHTTP2ProcessedResult, self).__init__(stage, result)
    ...
    def to_dict(self) -> Dict[str, Union[str, int, float]]:
        ...
        return {**graphql_result_dict, "query": self.query}
