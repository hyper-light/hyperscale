                    ...
                    for variant in experiments_metrics.variant_summaries:
                        if self._variants_table is None:
                            ...
                            variants_table = sqlalchemy.Table(
                                ...
                                sqlalchemy.Column(
                                    "variant_name", sqlalchemy.VARCHAR(255)
                                ),
                                sqlalchemy.Column(
                                ...
                                sqlalchemy.Column(
                                    "variant_completed", sqlalchemy.BIGINT
                                ),
                                sqlalchemy.Column(
                                    "variant_succeeded", sqlalchemy.BIGINT
                                ),
                                ...
                                sqlalchemy.Column(
                                    "variant_ratio_failed", sqlalchemy.FLOAT
                                ),
                                sqlalchemy.Column(
                                    "variant_ratio_aps", sqlalchemy.FLOAT
                                ),
                            )
