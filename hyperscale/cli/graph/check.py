...
def check_graph(path: str, log_level: str):
    ...
    hyperscale_core_config = hyperscale_config.get(
        "core",
        {"bypass_connection_validation": False, "connection_validation_retries": 3},
    )
    ...
    for name, obj in inspect.getmembers(module):
        if (
            ...
            and obj not in direct_decendants
        ):
            discovered[name] = obj
    ...
    graph = Graph(
        ...
        config={**hyperscale_core_config, "graph_module": module.__name__},
        cpus=1,
    )
