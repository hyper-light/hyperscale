...
@click.group(help="Commands to run graphs on and manage distributed instances of Hyperscale.")
def cloud():
    pass
...
@click.option(
    '--username',
    help='Hyperscale Cloud cluster username.'
)
@click.option(
    '--token',
    help='Hyperscale Cloud cluster auth token.'
)
@click.option(
    '--cluster',
    help='Hyperscale Cluster address.'
)
...
@cloud.group(help='Follow test progress as it runs on the specified Hyperscale Cloud cluster.')
...
@cloud.group(help='Update graph config for the specified graph on the specified Hyperscale Cloud cluster.')
@click.argument('graph_name')
@click.option(
    '--cluster',
    help='Hyperscale Cluster address.'
