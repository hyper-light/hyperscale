...
async def validate_51_1_result_dedupe_across_restarts() -> None:
    spec = _build_spec(
        "manager_worker_51_1_result_dedupe_across_restarts",
...
async def validate_51_2_result_merge_after_retries() -> None:
    spec = _build_spec(
        "manager_worker_51_2_result_merge_after_retries",
...
async def validate_51_3_result_schema_change() -> None:
    spec = _build_spec(
        "manager_worker_51_3_result_schema_change",
...
async def run() -> None:
    await validate_51_1_result_dedupe_across_restarts()
    await validate_51_2_result_merge_after_retries()
    await validate_51_3_result_schema_change()
