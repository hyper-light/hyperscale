...
async def validate_49_1_retry_budget_reset_on_failover() -> None:
    spec = _build_spec(
        "manager_worker_49_1_retry_budget_reset_on_failover",
...
async def validate_49_2_extension_early_completion() -> None:
    spec = _build_spec(
        "manager_worker_49_2_extension_early_completion",
...
async def validate_49_3_overlapping_retry_windows() -> None:
    spec = _build_spec(
        "manager_worker_49_3_overlapping_retry_windows",
...
async def run() -> None:
    ...
    await validate_49_3_overlapping_retry_windows()
