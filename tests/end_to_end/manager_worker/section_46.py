...
async def validate_46_1_starvation_prevention() -> None:
    spec = _build_spec(
        "manager_worker_46_1_starvation_prevention",
...
async def validate_46_2_uneven_core_fairness() -> None:
    spec = _build_spec(
        "manager_worker_46_2_uneven_core_fairness",
...
async def validate_46_3_priority_inversion() -> None:
    spec = _build_spec(
        "manager_worker_46_3_priority_inversion",
...
async def run() -> None:
    ...
    await validate_46_2_uneven_core_fairness()
    await validate_46_3_priority_inversion()
