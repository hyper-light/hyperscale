...
async def validate_52_1_snapshot_with_in_flight_dispatches() -> None:
    spec = _build_spec(
        "manager_worker_52_1_snapshot_with_in_flight_dispatches",
...
async def validate_52_2_restore_pending_cancellations() -> None:
    spec = _build_spec(
        "manager_worker_52_2_restore_pending_cancellations",
...
async def validate_52_3_stale_state_version_rejection() -> None:
    spec = _build_spec(
        "manager_worker_52_3_stale_state_version_rejection",
...
async def run() -> None:
    await validate_52_1_snapshot_with_in_flight_dispatches()
    await validate_52_2_restore_pending_cancellations()
    await validate_52_3_stale_state_version_rejection()
